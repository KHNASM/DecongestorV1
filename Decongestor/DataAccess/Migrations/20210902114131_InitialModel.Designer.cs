...
namespace Decongestor.DataAccess.Migrations
{
    ...
    [Migration("20210902114131_InitialModel")]
            ...
            modelBuilder.Entity("Decongestor.Domain.ChargeMatrix", b =>
                {
                    ...
                    b.Property<TimeSpan>("ToTimeOPfDayExclusive")
                        .HasColumnType("time");
                    ...
                    b.HasCheckConstraint("CK_ChargeMatrix_FromTimeOfDayInclusive_ToTimeOPfDayExclusive", "(ToTimeOPfDayExclusive > FromTimeOfDayInclusive)");
